// regisatration from validation working with some issue
...
const RegisterPage = () => {
  ...
  const signup = () => {
    ...
    if (!nameValidation) {
      ...
      setPassErr("A minimum 8 characters password contains a combination of uppercase, lowercase letter, number and special character are required.")
      return
    }
      ...
      <div className="mainbody1">
        ...
        <div className="row">
          ...
          <div className="col-md-4 float-end">
            {/* <div className="mainbody1"> */}
            <h2 className="title text-center" style={{ marginTop: 25 }}>Registration Form</h2>
            <div className="row">
              <div className="form">
                <div className="mb-3">
                  ...
                  />
                  {(!nameValidation) ? <div className="text-danger">{nameErr}</div> : <div className="text-success"> </div>}
                </div>
                ...
                <div className="mb-2">
                  ...
                  <input
                    ...
                    className="form-control"
                  />
                  {(!mobileValidation) ? <div className="text-danger">{mobErr}</div> : <div className="text-success">  </div>}
                </div>
                ...
                <div className="mb-2">
                  ...
                  <input
                    ...
                    className="form-control"
                  />
                  {(!cityValidation) ? <div className="text-danger">{cityErr}</div> : <div className="text-success">  </div>}
                </div>
                ...
                <div className="mb-2">
                  ...
                  {(!pincodeValidation) ? <div className="text-danger">{pinErr}</div> : <div className="text-success">  </div>}
                </div>
                ...
                <div className="mb-2">
                  ...
                  {(!stateValidation) ? <div className="text-success"></div> : <div className="text-danger">{stateErr}  </div>}
                </div>
                ...
                <div className="mb-2" style={{ marginTop: 15 }}>
                  ...
                  {(!userValidation) ? <div className="text-success"></div> : <div className="text-danger">{userErr}  </div>}
                ...
                <div className="mb-3" style={{ marginTop: 20 }}>
                  <button onClick={signup} className="btn btn-primary">
                    SignUp
                  </button><div className="float-end" style={{ marginTop: 10 }}>
                    Already Registered?{" "}
